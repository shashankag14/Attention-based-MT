...
class RNNModel(nn.Module):
    ...
    def forward(self, src, tgt):
        ...
        all_h = []
        # print("Shapes : emb_src {}, bi_src {}, emb_tgt {}".format(emb_src.shape, bi_src.shape, emb_tgt.shape))
        # print(emb_tgt.type)
        ...
        for i in range(len(embs)):
            ...
            # print("Shapes : att {}, current_c {}, current_h {}".format(att.shape, current_c.shape, current_h.shape))
            # print("shapes : emds{}: {}".format(i, embs[i].shape))
